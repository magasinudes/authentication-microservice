...
You can build by running : `docker build -t justin2997/authentication-world-java .`
You can run with : `docker run -p:8080:8080 -d justin2997/authentication-world-java:latest`
